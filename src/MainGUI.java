...
public class MainGUI {
    ...
    private JButton drawButton, importButton, backtrackingBtn, greedyBtn, dynamicBtn;
    ...
    public MainGUI(ButtonOperations buttonOperationsInput){
        ...
        this.importButton = buttonOperations.getImportBtn();
        ...
        this.minColorLabel = buttonOperations.getMinColorLabel();
        this.numVerticesLabel = buttonOperations.getNumVerticesLabel();
        this.numEdgesLabel = buttonOperations.getNumEdgesLabel();
    }
    ...
    private void createMainGraphPanel(){
        ...
        minColorLabel.setFont(new Font("SansSerif", Font.BOLD, 10));
        numVerticesLabel.setFont(new Font("SansSerif", Font.BOLD, 10));
        numEdgesLabel.setFont(new Font("SansSerif", Font.BOLD, 10));

        algoLabel.setForeground(Color.WHITE);
        executionTimeLabel.setForeground(Color.WHITE);
        statusLabel.setForeground(Color.WHITE);
        minColorLabel.setForeground(Color.WHITE);
        numVerticesLabel.setForeground(Color.WHITE);
        numEdgesLabel.setForeground(Color.WHITE);

        statusPanel.add(statusLabel);
        statusPanel.add(numVerticesLabel);
        statusPanel.add(numEdgesLabel);
        statusPanel.add(algoLabel);
        statusPanel.add(minColorLabel);
    ...
    private void designButtons(){
        ...
        addGUIButtonListeners(importButton);
    }
